...
public class ShoppingStep {
    ...
    public void shopping_requests_is_in_progress_status_should_appear() throws InterruptedException {
        Thread.sleep(10000);
        try {
            waitload();
    ...
    public void all_shopping_requests_should_appear() throws InterruptedException {
        Thread.sleep(10000);
        try{
            waitload();
